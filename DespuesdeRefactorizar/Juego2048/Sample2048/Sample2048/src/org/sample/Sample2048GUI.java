...
public class Sample2048GUI extends java.awt.Frame {
    ...
    private static final Logger LOGGER = Logger.getLogger(Sample2048GUI.class.getName());
    ...
    private void textField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField1KeyPressed
        ...
        LOGGER.log(Level.INFO, "This key is pressed {0}", evt.getKeyChar());
        boolean go = false;
        switch (choice) {
    ...
    public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(() -> new Sample2048GUI().setVisible(true));
    }
