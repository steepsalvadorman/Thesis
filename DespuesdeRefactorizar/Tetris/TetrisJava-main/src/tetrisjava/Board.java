...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener {
    ...
    private final transient BufferedImage pause;

    private final transient BufferedImage refresh;
...
private void drawGameOver(Graphics g) {
    if (gamePaused) {
        ...
        drawText(g, gamePausedString, 35);
    }
    if (gameOver) {
        String gameOverString = "GAME OVER";
        drawText(g, gameOverString, 50);
    }
}
...
private void drawScore(Graphics g) {
    ...
    g.drawString(String.valueOf(score), WindowGame.WIDTH - 125, WindowGame.HEIGHT / 2 + 30);
}
...
private void drawText(Graphics g, String text, int y) {
    ...
    g.drawString(text, 35, WindowGame.HEIGHT / 2 + y);
}
